...
class PolicyValueNet():
    ...
    def train_step(self, state_batch, next_state_batch, mcts_probs, winner_batch, lr):
        ...
        value_loss = F.mse_loss(value.view(-1), winner_batch + self.gamma * next_value.view(-1))
